...
Consulta, búsqueda y paginación del historial de comandos ejecutados en el servidor remoto directamente desde el archivo de historial nativo de la sesión activa.
