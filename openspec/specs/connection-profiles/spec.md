...
#### Scenario: Cajita con chrome de tarjeta (no fila plana)
- **WHEN** el usuario ve conexiones en el árbol en estado de reposo
- **THEN** cada conexión se percibe como cajita (fondo/borde/radius de tarjeta) y las carpetas siguen compactas sin ese chrome
